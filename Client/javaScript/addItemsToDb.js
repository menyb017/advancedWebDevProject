...
document
  .getElementById("modifyTheUserDb")
  .addEventListener("submit", async function (event) {
...
async function DisplayProdsInSelect() {
  ...
  products.forEach((product) => {
    ...
    option.textContent =
      "name: " + product.productName + " / id: " + product.productId;
...
async function DisplayProdsInLabel() {
  ...
  if (product) {
    document.getElementById("itemCategoryUpdate").value =
    ...
    document.getElementById("itemDescriptionUpdate").value =
      product.productDescription;
    document.getElementById("itemPriceUpdate").value = product.productPrice;
    document.getElementById("itemQuantityUpdate").value =
